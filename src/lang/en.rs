...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Connecting to the CertDesk network..."),
        ...
        ("install_tip", "Due to UAC, CertDesk can not work properly as the remote side in some cases. To avoid UAC, please click the button below to install CertDesk to the system."),
        ("config_acc", "In order to control your Desktop remotely, you need to grant CertDesk \"Accessibility\" permissions."),
        ("config_screen", "In order to access your Desktop remotely, you need to grant CertDesk \"Screen Recording\" permissions."),
        ...
        ("android_input_permission_tip1", "In order for a remote device to control your Android device via mouse or touch, you need to allow CertDesk to use the \"Accessibility\" service."),
        ("android_input_permission_tip2", "Please go to the next system settings page, find and enter [Installed Services], turn on [CertDesk Input] service."),
        ...
        ("android_open_battery_optimizations_tip", "If you want to disable this feature, please go to the next CertDesk application settings page, find and enter [Battery], Uncheck [Unrestricted]"),
        ...
        ("config_input", "In order to control remote desktop with keyboard, you need to grant CertDesk \"Input Monitoring\" permissions."),
        ...
        ("still_click_uac_tip", "Still requires the remote user to click OK on the UAC window of running CertDesk."),
        ("config_microphone", "In order to speak remotely, you need to grant CertDesk \"Record Audio\" permissions."),
        ...
        ("confirm_idd_driver_tip", "The option to install the virtual display driver is checked. Note that a test certificate will be installed to trust the virtual display driver. This test certificate will only be used to trust CertDesk drivers."),
        ...
        ("enter_rustdesk_passwd_tip", "Enter CertDesk password"),
        ("remember_rustdesk_passwd_tip", "Remember CertDesk password"),
        ("login_linux_tip", "You need to login to remote Linux account to enable a X desktop session"),
        ("verify_rustdesk_password_tip", "Verify CertDesk password"),
